...
export const en: Metinler = {
  ...
  gerekce: {
    ...
    ekipmanlar: {
      ...
      kablo_makinesi: 'Cable machine',
      smith_makinesi: 'Smith machine',
      barfiks_bari: 'Pull-up bar',
      dip_bari: 'Dip bar',
      duz_bench: 'Flat bench',
      egimli_bench: 'Incline bench',
      ayarlanabilir_bench: 'Adjustable bench',
      direnc_bandi: 'Resistance band',
      kosu_bandi: 'Treadmill',
      sabit_bisiklet: 'Stationary bike',
      kurek_makinesi: 'Rowing machine',
      merdiven: 'Stair machine',
      trx: 'TRX',
      squat_rack: 'Squat rack',
      makine_gogus: 'Chest machine',
      makine_hamstring: 'Hamstring machine',
      makine_quadriceps: 'Quadriceps machine',
      makine_sirt: 'Back machine',
      makine_omuz: 'Shoulder machine',
      makine_baldir: 'Calf machine',
      makine_abduktor: 'Abductor machine',
      preacher_bench: 'Preacher bench',
      roman_chair: 'Roman chair',
      plyo_box: 'Plyo box',
    },
    kontrendikasyonlar: {
      bel_fitigi: 'Lower back disc',
      boyun_fitigi: 'Neck disc',
      omuz_sikismasi: 'Shoulder impingement',
      omuz_instabilite: 'Shoulder instability',
      diz_menisküs: 'Knee meniscus',
      diz_patellofemoral: 'Front knee pain',
      dirsek_tendinit: 'Elbow tendinitis',
      bilek_agrisi: 'Wrist pain',
      kalca_impingement: 'Hip impingement',
      ayak_bilegi_kisitli: 'Limited ankle',
      tansiyon_kontrolsuz: 'Uncontrolled blood pressure',
    },
    gruplar: {
      gogus: 'Chest',
      sirt: 'Back',
  ...
  apiHatalari: {
    ...
    analiz_yok: () =>
      'You do not have a body analysis yet. You can create one with your measurements or a photo.',
  ...
  giris: {
    ...
    maddeler: [
      ...
      {
        etiket: 'PRIVACY',
        metin: 'Your photo is deleted the moment it is analysed. It never reaches our disk.',
      },
      { etiket: 'TONE', metin: 'No badges, no streaks, no confetti.' },
    ],
    basla: 'Start',
  ...
  beslenme: {
    ...
    sonrakiGun: 'Next day',
    buguneDon: 'Back to today',
    kalanKalori: (kcal: number) => `${kcal} kcal left`,
    asimKalori: (kcal: number) => `${kcal} kcal over`,
    ogunYok: 'No meal selected',
    suPayda: (ml: number) => `/ ${ml} ml`,
    suBardakEkle: 'Add a glass',
    suGeriAl: 'Undo',
    suKaynak: 'Target from the EFSA adequate intake; source in Settings > Sources.',
  ...
  ogun: {
    ...
    deste: {
      ...
      kilitBaslik: 'The meal deck opens with the Temel plan',
  ...
  paywall: {
    ...
    planlarYuklenemedi: "Couldn't load the plans. Check your connection and try again.",
