...
Ödeme Google Play hesabından tahsil edilir. Abonelik, dönem bitiminden en az 24 saat
önce iptal edilmezse otomatik yenilenir. Yenilemeyi Google Play hesap ayarlarından ya
da uygulama içinden tek dokunuşla kapatabilirsin; dönem sonuna kadar özellikler açık
kalır.
...
**Uygulama reklam içermiyor.** Hak tablosunda her plan için `reklam: false`; kodda
hiçbir reklam SDK'sı yok.
